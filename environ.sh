...
8)
   ...
   elif test -e "/opt/rs97tools/"; then
     export OPENDINGUX_TOOLCHAIN=/opt/rs97tools/mipsel-RetroFW-linux-uclibc/
     export OPENDINGUX_TOOLCHAIN_PREFIX=/opt/rs97tools/mipsel-RetroFW-linux-uclibc/sysroot/usr/
     export PATH=$PATH:$OPENDINGUX_TOOLCHAIN/usr/bin
     export BUILD_GCW0=1
   fi
